...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'news_person', 'twitter_id',
                      self.gf('django.db.models.fields.CharField')(default='xx', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.twitter_id'
        db.delete_column(u'news_person', 'twitter_id')
    ...
    models = {
        ...
        u'news.person': {
            ...
            'entertainment_preferences': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'followers'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['news.Entertainment']"}),
            ...
            'twitter_id': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
