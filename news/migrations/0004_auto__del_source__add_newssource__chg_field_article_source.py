...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field news_sources on 'Person'
        m2m_table_name = db.shorten_name(u'news_person_news_sources')
        ...
        db.alter_column(u'news_article', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['news.NewsSource']))

    def backwards(self, orm):
        # Adding model 'Source'
        db.create_table(u'news_source', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'news', ['Source'])

        # Deleting model 'NewsSource'
        db.delete_table(u'news_newssource')

        # Removing M2M table for field news_sources on 'Person'
        db.delete_table(db.shorten_name(u'news_person_news_sources'))


        # Changing field 'Article.source'
        db.alter_column(u'news_article', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['news.Source']))
    ...
    models = {
        ...
        u'news.person': {
            ...
            'news_sources': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'followers'", 'symmetrical': 'False', 'to': u"orm['news.NewsSource']"}),
